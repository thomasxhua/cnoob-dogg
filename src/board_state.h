...
#define MOVE_TO_STRING_SIZE (2 * SQUARE_TO_STRING_SIZE + 2)
...
size_t board_state_get_pseudo_legal_moves_knights(const BoardState* state, Move* moves, size_t moves_size);
size_t board_state_get_pseudo_legal_moves_bishops(const BoardState* state, Move* moves, size_t moves_size);
size_t board_state_get_pseudo_legal_moves_rooks(const BoardState* state, Move* moves, size_t moves_size);
size_t board_state_get_pseudo_legal_moves_queens(const BoardState* state, Move* moves, size_t moves_size);
size_t board_state_get_pseudo_legal_moves_kings(const BoardState* state, Move* moves, size_t moves_size);
